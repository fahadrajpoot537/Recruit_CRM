                                ...
                                <tbody>
                                    ...
                                    @foreach ($jobs as $job)
                                        <tr data-job-id="{{ $job->id }}">
                                            ...
                                            <td>{{ $job->primaryContact?->first_name.' '.$job->primaryContact?->last_name }}</td>
        ...
        async function editJob(jobId) {
            try {
                ...
                const fieldsToPopulate = [
                    ...
                    'note_for_candidates', 'collaborator', 'skills', 'attachments','primary_contact_id','secondary_contacts'
                ];
...
console.log(collab.contact_id);
                            const option = secondarySelect.querySelector(`option[value="${collab.contact_id}"]`);
                            if (option) option.selected = true;
                        });
                        if (typeof $ !== 'undefined' && $.fn.select2) {
