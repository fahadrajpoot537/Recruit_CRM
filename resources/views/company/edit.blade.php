        ...
        <div class="row">
            ...
            <div class="col-md-6 mb-3">
                ...
                <select name="industry" class="form-control">
                    ...
                    @php
                    $industries = [
                    "Information Technology", "Healthcare", "Finance", "Education", "Retail", "Manufacturing",
                    "Construction", "Real Estate", "Telecommunications", "Transportation & Logistics", "Hospitality",
                    "Legal", "Government", "Marketing & Advertising", "Media & Entertainment", "Oil & Gas",
                    "Energy & Utilities", "Agriculture", "Non-Profit", "Aerospace & Defense", "Automotive",
                    "Food & Beverage", "Pharmaceuticals", "Banking", "Insurance", "E-commerce", "Environmental
                    Services",
                    "Human Resources", "Fashion & Apparel", "Biotechnology", "Consulting", "Security & Surveillance",
                    "Marine", "Printing & Publishing", "Mining & Metals", "Events & Conferences", "Customer Service",
                    "Sports & Recreation"
                    ];
                    @endphp
