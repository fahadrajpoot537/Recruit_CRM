                    ...
                    <div class="row auth-split">
                                    ...
                                    <div class="row">
                                        <div class="col-xl-7 col-sm-10 mx-auto">
                                            <div class="text-center mb-4">
                                                ...
                                                <p>There are many variations of passages of Lorem Ipsum available, in
                                            ...
                                            <div class="row gx-3">
                                                ...
                                                <div class="form-group col-lg-12">
                                                    ...
                                                    <a href="{{ route('google.login') }}"
                                                        class="mt-2 btn btn-outline-dark btn-rounded btn-block mb-3"><span><span
                                                                class="icon"><i
                                                                    class="fab fa-google"></i></span><span>Sign In with
                                                                Google</span></span></a>
                                                </div>
                                            </div>
                        ...
                        <div
                            ...
                            <div class="auth-content flex-column text-center py-8">
                                ...
                                <img src="dist/img/macaroni-logged-out.png" class="img-fluid w-sm-50 mt-7"
                                    alt="login" />
                            </div>
