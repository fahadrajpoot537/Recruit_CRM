...
<head>
    ...
    <title>Register | Recruit CRM</title>
                ...
                <div class="container-fluid">
                    ...
                    <div class="row auth-split">
                        <div
                                ...
                                <div class="row">
                                    <div class="col-xxl-8 mx-auto">
                                        <div class="text-center">
                                            <h3 class="text-white mb-2">High quality Bootstrap template for your next
                                                web project.</h3>
                                            <p class="text-white">Start your <u>14 Days FREE</u> trial.</p>
                                        </div>
                                        <ul class="list-icon text-white mt-4">
                                            <li class="mb-1">
                                                <p><i class="ri-check-fill"></i><span>There are many variations of
                                        ...
                                        <div class="row gx-3 mt-7">
                                            <div class="col-lg-6">
                                                <div class="card card-shadow">
                                                    <img class="card-img-top" src="dist/img/slide1.jpg"
                                                        alt="Card image cap">
                                                    <div class="card-body">
                                            ...
                                            <div class="col-lg-6">
                                                <div class="card card-shadow">
                                                    <img class="card-img-top" src="dist/img/slide2.jpg"
                                                        alt="Card image cap">
                                                    <div class="card-body">
                            ...
                            <p class="p-xs text-white credit-text opacity-55">All illustration are powered by <a
                                    href="https://icons8.com/ouch/" target="_blank" class="link-white"><u>OUCH</u></a>
                            </p>
                        </div>
                            ...
                            <div class="auth-content flex-column pt-8 pb-md-8 pb-13">
                                <div class="text-center mb-7">
                                    <a class="navbar-brand me-0" href="index.html">
                                        ...
                                        <img class="brand-img d-inline-block mb-2" src="dist/img/brand-sm.svg"
                                            alt="brand" />
                                        <label for=""
                                    ...
                                    <div class="row">
                                        <div class="col-xxl-5 col-xl-7 col-lg-10 mx-auto">
                                            ...
                                            <div class="form-check form-check-sm mb-3">
                                                ...
                                                <label class="form-check-label text-muted fs-8" for="logged_in">By
                                                    creating an account you specify that you have read and agree with
                                                    our <a href="#">Tearms of use</a> and <a href="#">Privacy
                                                        policy</a>. We may keep you inform about latest updates through
                                                    our default <a href="#">notification settings</a></label>
                                            </div>
                                            <!-- <a href="#" class="btn btn-primary btn-rounded btn-uppercase btn-block">Create account</a> -->
                                            <button class="btn btn-primary btn-rounded btn-uppercase btn-block">Create
                                                Account</button>
                                            <p class="p-xs mt-2 text-center">Already a member ? <a
                                                    href="{{route('login')}}"><u>Sign In</u></a></p>
                                        </div>
                                    </div>
                                </form>
                            </div>
                                ...
                                <footer class="container-xxl footer">
                                    <div class="row">
                                        <div class="col-xl-8 text-center">
                                            <p class="footer-text pb-0"><span class="copy-text">Jampack © 2023 All
