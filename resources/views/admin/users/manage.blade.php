                                                    ...
                                                    <div class="user-desg"><span
                                                        ...
                                                        <div class="card-footer text-muted position-relative">
                                                            ...
                                                            <a href="#" class="d-flex align-items-center"
                                                                data-bs-toggle="modal" data-bs-target="#contact_detail"
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-sm-12 col-md-7">
                                                <ul
                                                    ...
                                                    <li class="dt-paging-button page-item previous disabled"><a
                                                            href="#" data-dt-idx="0" tabindex="0"
                                                    ...
                                                    <li class="dt-paging-button page-item next"><a href="#"
                                                            data-dt-idx="4" tabindex="0" class="page-link"><i
            ...
            $('a[data-bs-target="#contact_detail"]').on('click', function() {
                ...
                try {
                    if (companies && companies !== '[]') {
                        var companiesData = typeof companies === 'string' ? JSON.parse(companies) :
                            companies;
